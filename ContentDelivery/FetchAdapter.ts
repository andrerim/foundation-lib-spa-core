import { AxiosResponse, AxiosAdapter, InternalAxiosRequestConfig  } from 'axios';
 ...
 */
export const FetchAdapter : CachingFetchAdapter = async (config: InternalAxiosRequestConfig) : Promise<AxiosResponse> => 
{
